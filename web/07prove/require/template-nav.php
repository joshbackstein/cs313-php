<?php
  ...
  // Get the member ID and username
  $current_member_id = getCurrentMemberId();
  refreshMemberSession($current_member_id);
?>
  ...
  <div class="collapse navbar-collapse text-center" id="navbarCollapse">
    ...
    <ul class="navbar-nav ml-auto align-items-center">
      ...
      <li class="<?php echo $nav_item_class; ?>">
        <a class="nav-link font-italic font-weight-bold" href="index.php"><?php echo getCurrentDisplayName(); ?></a>
      </li>
      <li class="<?php echo $nav_item_class; ?>">
